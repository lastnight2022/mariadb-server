...
public:
  ...
  */
  enum store_key_result copy(THD *thd)
  {
    ...
    Utf8_narrow_RAII tmp(to_field, do_cset_narrowing);
...
class store_key_field: public store_key
{
 ...
 public:
  ...
  {
    do_cset_narrowing= 
      Utf8_narrow_RAII::should_do_narrowing(copy_field.to_field,
...
public:
	       ...
	       &err : (uchar*) 0, length), item(item_arg), use_value(val)
  {
    ...
    do_cset_narrowing= 
      Utf8_narrow_RAII::should_do_narrowing(to_field,
